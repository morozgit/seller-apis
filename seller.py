...
def get_product_list(last_id, client_id, seller_token):
    ...
    Делает API-запрос на сайт озон. Для корректного запроса необходим идентификатор клиента и идентификатор продавца.
...
def get_offer_ids(client_id, seller_token):
    ...
    3. Берет из json количество товаров и последний идентификатор
    Цикл длится до тех пор, пока количество товаров не будет ровняться длине списка товаров
...
def create_stocks(watch_remnants, offer_ids):
    """Создать запасы.
        ...
        В цикле по остаткам, которые вернула функция download_stock(), и если количество товара
        больше 10 то запас 100, если количество товара 1 то запаса нет иначе запас равен количеству товара.
