...
def get_product_list(page, campaign_id, access_token):
    """Получить список товаров Яндекс-Маркета.
        ...
        Делает API-запрос на сайт Яндекс-Маркета. Для корректного запроса необходим идентификатор поставщика и
        токен для авторизации на Яндекс-Маркете.
        ...
        Возвращаемое значение:
            Список товаров магазина - это результат, который хранится в json формате
...
def update_stocks(stocks, campaign_id, access_token):
    """Обновить остатки.
        ...
        Делает API-запрос на сайт Яндекс-Маркета. Для корректного запроса необходим идентификатор поставщика,
        токен для авторизации на Яндекс-Маркете, и список с остатками.
...
def update_price(prices, campaign_id, access_token):
    """Обновить цены товаров.
        ...
        Делает API-запрос на сайт Яндекс-Маркета. Для корректного запроса необходим идентификатор поставщика,
        токен для авторизации на Яндекс-Маркете, и список с ценами.
...
def get_offer_ids(campaign_id, market_token):
    """Получить артикулы товаров Яндекс маркета.
        ...
        В первом цикле:
        1. Обрабатывает возврат функции get_product_list().
        2. Добавляет в список артикулы товаров из json
        3. Берет из json следующую страницу с товарами и если она не существует, то выходит из цикла.

        Во втором цикле формируется список предложений из списка товаров
