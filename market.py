...
def update_price(prices, campaign_id, access_token):
    """Установить цены товаров.
        ...
        Возвращаемое значение:
            str: Статус выполнения запроса. OK : Запрос выполнен успешно. ERROR : Произошла ошибка.
...
async def upload_prices(watch_remnants, campaign_id, market_token):
    """Обновить цену.
        ...
        Возвращаемое значение:
            list: Обновленный список с ценами
...
async def upload_stocks(watch_remnants, campaign_id, market_token, warehouse_id):
    """Обновить остатки.
        ...
        Возвращаемое значение:
            list: Обновленный список с остатками товара
            list: Список товара на который есть запас
